    ...
    <div className="text-white w-full overflow-x-hidden">
      ...
      <section className="py-16 bg-gray-100 w-full">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="text-xl sm:text-2xl font-bold text-[#6C5332] text-center"
        >
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="p-6 flex flex-col flex-grow">
              <h3 className="text-xl font-bold text-[#6C5332] mb-2">Our Vision</h3>
          ...
          >
            ...
            />
            <div className="p-6 flex flex-col flex-grow">
              <h3 className="text-xl font-bold text-[#6C5332] mb-2">Our Mission</h3>
              ...
              <h2 className="text-amber-900 text-lg font-bold mb-2">MISSION DETAILS</h2>
